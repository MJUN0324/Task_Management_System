...
<head>
    <title>HKVEP Online Task - Company</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="content">
        <?php 
            ...
            $taskList = $controller->getTaskListByCompanyID(unserialize($_SESSION["info"])->get_id());
        ?>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <div class="list-group">
                        <a href="add_task.php" class="list-group-item list-group-item-action">
                            <div class="d-flex w-100 justify-content-center">
                                <p><b><i class="fas fa-plus fa-fw"></i>Add Task</b></p>
                            </div>
                        </a>    

                        <?php foreach($taskList as $task) { ?>
                            <a href="task_panel.php?id=<?= $task->get_task_id() ?>" class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1"><?= $task->get_task_name() ?></h5>
                                    <?= ($task->is_disabled()) ? '<small class="text-danger">Deleted</small>' : '' ?>
                                </div>
